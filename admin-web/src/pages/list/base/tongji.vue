<template>
  <div>
    <card class="list-card-container">
      <t-row justify="space-between">
        <div class="left-operation-container">
          <t-breadcrumb :max-item-width="'150'">
            ...
            <t-breadcrumbItem>统计</t-breadcrumbItem>
          </t-breadcrumb>
        </div>
      </t-row>
      ...
      <t-tabs v-model="tabItem">
        <t-tab-panel :value="1" label="开票统计"> </t-tab-panel>
        <t-tab-panel :value="2" label="作废统计"> </t-tab-panel>
        <t-tab-panel :value="3" label="冲红统计"> </t-tab-panel>
      </t-tabs>
