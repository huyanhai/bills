<template>
  <view class="page-tixian">
    ...
    <view class="tips">
      ...
      <view class="info">
        1.{{ pageData.secondWithdrawalMoney }}元以下秒到 <br />
        2.最大金额{{ pageData.maxWithdrawalMoney }}
      </view>
      <van-button type="info" class="ui-btn" @click="tixian" v-if="pageData.onoff === 1"
        >立即提现</van-button
      >
    </view>
